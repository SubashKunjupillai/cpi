            ...
            link: function (scope, element, attr, ngModel) {
                ...
                if (attr.wysiwyg === 'minimal') {
                    ...
                    editorOptions = {
                        ...
                        removeButtons: 'About,Form,Checkbox,Radio,TextField,Textarea,Select,Button,ImageButton,HiddenField,Save,CreateDiv,Language,BidiLtr,BidiRtl,Flash,addFile,Styles',
                        allowedContent: true
                    };
                }
