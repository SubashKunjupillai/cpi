...
var app=angular.module("fileUpload",["ngFileUpload"]);app.controller("MyCtrl",["$scope","Upload","$timeout",function(a,o,l){a.uploadFiles=function(t,n){a.files=t,a.errFiles=n,angular.forEach(t,function(t){t.upload=o.upload({url:"https://angular-file-upload-cors-srv.appspot.com/upload",data:{file:t}}),t.upload.then(function(a){l(function(){t.result=a.data})},function(o){o.status>0&&(a.errorMsg=o.status+": "+o.data)},function(a){t.progress=Math.min(100,parseInt(100*a.loaded/a.total))})})}}]);
