...
var service = {};
console.log("Loading patriortist service");
...
function getAll() {
    ...
    db.patriortists.find().sort({ publishDate: -1 }).toArray(function (err, videos) {
...
function create(patriortistParam) {
  console.log("Creating table");
    var deferred = Q.defer();

    db.patriortist.insert(
        patriortistParam,
        function (err, doc) {
            if (err) deferred.reject(err.name + ': ' + err.message);
